        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {jobs.map((job, index) => (
            <motion.div
              ...
              className="group bg-[#111111] border border-[#222] rounded-3xl p-8 transition-all duration-300 hover:border-blue-600/40 hover:shadow-[0_0_30px_rgba(37,99,235,0.15)]"
            >
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                <span className="flex items-center gap-2 bg-[#1A1A1A] text-gray-300 px-3 py-2 rounded-full text-sm">

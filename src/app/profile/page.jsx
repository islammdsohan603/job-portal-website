...
const UserAvatar = ({ name, image }) => {
  ...
  return (
    <div className="flex h-28 w-28 shrink-0 items-center justify-center overflow-hidden rounded-full bg-violet-500/20 text-4xl font-bold text-violet-100 ring-4 ring-white/10">
      {shouldShowImage ? (
  ...
  return (
    <div className="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/[0.03] p-5 transition-colors hover:bg-white/[0.06]">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 break-words text-base font-medium text-zinc-100">
          {value}
        </p>
      </div>
    </div>
...
const ProfileSkeleton = () => (
  <div className="min-h-screen bg-[#0B0B0F] px-4 py-28">
    <div className="mx-auto w-full max-w-5xl">
      <div className="rounded-3xl border border-white/10 bg-[#111118]/80 p-6 shadow-2xl shadow-black/30 md:p-10">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="h-5 w-72 max-w-full animate-pulse rounded-full bg-white/10" />
  ...
  return (
    <main className="min-h-screen bg-[#0B0B0F] px-4 py-28 text-white">
      <section className="mx-auto w-full max-w-5xl">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#111118]/90 p-6 shadow-2xl shadow-black/30 md:p-10">
          ...
          <div className="flex flex-col gap-7 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
              ...
              <div className="min-w-0">
                <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-violet-400/20 bg-violet-500/10 px-4 py-2 text-sm font-semibold text-violet-200">
                  <ShieldCheck size={16} />
                  My Profile
                </div>
                ...
                {user.email && (
                  <p className="mt-3 break-words text-base text-zinc-400 md:text-lg">
                    {user.email}
                  </p>
                )}
              </div>
            ...
            <div className="rounded-2xl border border-orange-400/20 bg-orange-500/10 px-5 py-4 text-orange-100">
